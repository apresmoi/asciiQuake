...
export const QUAKE_MENU_OPTIONS_ROWS: readonly { id: string; label: string; y: number }[] = [
  ...
  { id: "glyph-detail", label: "ASCII detail", y: 97 },
  { id: "glyph-palette", label: "ASCII glyphs", y: 105 },
  { id: "mute-sounds", label: "Mute sounds", y: 113 },
  { id: "show-particles", label: "Show particles", y: 121 },
  { id: "show-enemies", label: "Show enemies", y: 129 },
  { id: "disable-damage", label: "Disable damage", y: 137 },
  { id: "disable-movement", label: "Disable movement", y: 145 },
  { id: "disable-attacks", label: "Disable attacks", y: 153 },
  { id: "invert-mouse", label: "Invert mouse", y: 161 },
];
